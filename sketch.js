...
function preload(){//https://pbs.twimg.com/media/FBC4kAEXMAIlDLY.png
  ...
  img = loadImage('https://images.unsplash.com/photo-1578489758854-f134a358f08b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80');
  //img = loadImage('https://images.unsplash.com/photo-1578489758854-f134a358f08b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80');10*4
}


function setup() {
    //blendMode(ADD);
	createCanvas(canvas.width='1365', canvas.height='910');
	img.resize(canvas.width='1365', canvas.height='910');//　divive like /2 if retina or..
